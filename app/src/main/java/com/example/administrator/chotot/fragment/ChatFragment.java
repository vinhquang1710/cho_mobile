...
public class ChatFragment extends Fragment {
    ...
    private void setViewPager(){
        tabLayout.addTab(tabLayout.newTab().setText(getResources().getString(R.string.ibuy)));
        tabLayout.addTab(tabLayout.newTab().setText(getResources().getString(R.string.isell)));
    ...
    class FragmentAdapterClass extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    BuyChatFragment tab1 = new BuyChatFragment();
                    return tab1;

                case 1:
                    SellChatFragment tab2 = new SellChatFragment();
                    return tab2;
