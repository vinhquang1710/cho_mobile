...
import com.example.administrator.chotot.adapter.ProductsAdapter.MyViewHolder;
...
public class ProductsAdapter extends Adapter<MyViewHolder>{
    ...
    public ProductsAdapter(Context mContext, ArrayList<Product> mArr, OnItemClickListener mListener) {
